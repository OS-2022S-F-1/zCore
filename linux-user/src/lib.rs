...
pub fn open(path: &str, flags: OpenFlags) -> isize {
    sys_openat(AT_FDCWD as usize, path, flags.bits, OpenFlags::RDWR.bits, 0 as *const u8)
}

pub fn eopen(path: &str, flags: OpenFlags, key: &[u8]) -> isize {
    sys_openat(AT_FDCWD as usize, path, flags.bits, OpenFlags::RDWR.bits, key.as_ptr())
}
